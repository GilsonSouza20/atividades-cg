...
{
	glfwInit();
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Suzanne - Trajetoria Gilson Junior", nullptr, nullptr);
	...
	loadOBJ("../images/objects/SuzanneTriTextured.obj");
	loadMTL("../images/objects/" + mtlFilePath);
	GLuint textureID = loadTexture("../images/textures/" + textureFilePath);
	...
	std::vector<glm::vec3> controlPoints = generateControlPointsSet("../animation/config.txt");
