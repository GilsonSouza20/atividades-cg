 ...
 * Última atualização em 02/07/2023
 *
 */
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "3D Cubes Gilson Junior", nullptr, nullptr);
...
int setupGeometry()
{
    std::vector<float> vertices = parseOBJFile("images/cube.obj");
